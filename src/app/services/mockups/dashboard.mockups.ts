...
// ============ MOCKUP DE INGREDIENTES ============
export const mockIngredients: DashboardIngredients[] = [
  {
    id: 1,
    id_producto_stock: 1,
    producto: "Pan casero",
  ...
  },
  {
    id: 4,
    id_producto_stock: 2,
    producto: "Bizcocho de vainilla",
    id_inventory: 1,
    ingrediente: "Harina",
    tipo: "Cereales",
    cantidades: 0.3,
    unidad: "kg",
    fecha_registro: "2025-01-22 09:10:00",
  },
  {
    id: 5,
    id_producto_stock: 2,
  ...
  },
  {
    ...
    cantidades: 0.5,
    unidad: "kg",
    fecha_registro: "2025-01-22 09:20:00",
  },
  {
    id: 8,
    id_producto_stock: 3,
  ...
  },
  {
    ...
    cantidades: 0.4,
    unidad: "kg",
    fecha_registro: "2025-01-23 08:00:00",
  },
  {
    id: 10,
    id_producto_stock: 4,
...
// ============ MOCKUP DE DASHBOARD (enfoque ventas) ============
export const mockSalesDashboardData: DashboardData = {
  recipes: [],
  stock: [],
  inventory: [],
  ingredients: [],
