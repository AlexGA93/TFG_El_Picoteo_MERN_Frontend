...
import { RecipeCreateModalComponent } from '../components/recipes/recipe-create-modal/recipe-create-modal.component';
import { RecipeEditModalComponent } from '../components/recipes/recipe-edit-modal/recipe-edit-modal.component';
...
@Component({
  ...
  imports: [CommonModule, CurrencyPipe, LoaderComponent, LucideAngularModule, RouterLink, UnitFormatPipe, RecipeCreateModalComponent, RecipeEditModalComponent, TranslatePipe],
